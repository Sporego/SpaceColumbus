...
namespace HeightMapGenerators {
    ...
    public class HeightMap {
        ...
        public void applyNormalizedHalfSphere (float[, ] elevations, float intensity = 1f, int diameter = -1, float sphereMaxValue = 1f, bool overwrite = false, bool orientation = false) {

            ...
            SubShader
        {
            ...
            CGPROGRAM
                ...
                void surf(Input IN, inout SurfaceOutput o)
                {
                    ...
                    float2 offset = normal.xy * _BGTex_TexelSize.xy * _Focus;
                    IN.proj.xy = offset * IN.proj.z + IN.proj.xy;
                    half4 ref = tex2Dproj(_BGTex, UNITY_PROJ_COORD(IN.proj));
